...
public class PostWindo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmessagesAdpter = new MessageAdapter(PostWindo.this, messagesArrayList);
        ...
        DatabaseReference reference = database.getReference().child("group").child(firebaseAuth.getUid());
        DatabaseReference chatreference = database.getReference().child("group_chat").child(senderRoom).child("messages");
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(taskSnapshot -> {
                    ...
                    storageReference.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(PostWindo.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
                    });
                })
                .addOnFailureListener(e -> {
                    // Handle unsuccessful uploads
                    Toast.makeText(PostWindo.this, "Image upload failed", Toast.LENGTH_SHORT).show();
                });
    }
            ...
            storageReference.putFile(Uri.fromFile(new File(voiceFilePath)))
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        storageReference.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            // You can optionally display a message or enable the send button here
                            Toast.makeText(PostWindo.this, "Voice uploaded successfully", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(e -> {
                        ...
                        Toast.makeText(PostWindo.this, "Voice upload failed", Toast.LENGTH_SHORT).show();
                    });
        }
    }
